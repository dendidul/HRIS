...
{
    public class OvertimeTimesheetController : GlobalAccessMenuController
    {
        ...
        public OvertimeTimesheetController(IConfiguration config, ICookie cookie) : base(config, cookie)
        {
