...
{
    public class TimeCalculationController : GlobalAccessMenuController
    {
        ...
        public TimeCalculationController(IConfiguration config, ICookie cookie) : base(config, cookie)
        {
